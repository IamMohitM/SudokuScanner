...
_SCALEWORKERREQUEST = DESCRIPTOR.message_types_by_name['ScaleWorkerRequest']
_SETDEFAULTREQUEST = DESCRIPTOR.message_types_by_name['SetDefaultRequest']
...
_MANAGEMENTAPISSERVICE = DESCRIPTOR.services_by_name['ManagementAPIsService']
